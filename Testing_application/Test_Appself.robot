...
ApplicationPortal_Self
    ...
    Sleep    10    
    Click Element    xpath=/html/body/div[2]/div[3]/div[1]/form/div/div[1]/div[5]/div[2]/div[2]/button/span[1]    
    wait    
    ...
    wait   
    Click Image    xpath=//*[@id="customized-menu"]/div[3]/ul/li[1]/div/div[1]/img    
    wait
    Click Element    xpath=//*[@id="root"]/div/div/header/div/div[1]/div[3]/div/div/div    
    wait
    Click Image    xpath=//*[@id="customized-menu"]/div[3]/ul/li[3]/div/div[1]/img    
    Sleep    10 
    #Login details   
